...
% Use bisection method to compute N (the mean square value of the angle random walk noise)
higher = 1;
lower = 1e-10;
for i = 1:100
    N = (higher+lower)/2;
...
% Use bisection method to compute K (the mean square value of the rate random walk noise)
higher = 1;
lower = 1e-10;
for i = 1:100
    K = (higher+lower)/2;
